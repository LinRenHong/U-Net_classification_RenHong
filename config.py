...
parser.add_argument("--pretrain_model_path", type=str, default=r"pretrain_models/best_UNet_447.pth", help="model path")
parser.add_argument("--load_model_path", type=str, default=r"YOUR_MODEL_PATH", help="model path")

parser.add_argument("--epoch", type=int, default=0, help="epoch to start training from")
parser.add_argument("--n_epochs", type=int, default=200, help="number of epochs of training")
parser.add_argument("--dataset_path", type=str, default=r"dataset/glaucoma_0812", help="name of the dataset")
...
parser.add_argument("--dr", type=float, default=0.2, help="dropout rate") # Use on classification
...
parser.add_argument("--num_of_class", type=int, default=2, help="number of class")
